...
function ScoreDropdown({
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        className={`w-15 px-1 py-2 border-yellow-400 text-center focus:ring-2 focus:ring-blue-500 focus:border-blue-500 min-h-[40px] inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground ${getScoreColor(
          value
        )}`}
      >
        {value || ""}
